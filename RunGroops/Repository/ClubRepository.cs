...
namespace RunGroops.Repository
{
...

	{
		...
		public async Task<Club> GetClubAsyncNoTracking(int id)
		{
			var club = await _applicationDbContext.Clubs.Include(c => c.Address).AsNoTracking().FirstOrDefaultAsync(c => c.Id == id);
			return club;
		}
